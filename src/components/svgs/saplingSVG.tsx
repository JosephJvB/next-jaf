...
export const SaplingSVG: FC<SaplingProps> = (props) => {
  return (
    <svg version="1.1" viewBox="0 0 512 512" fill="white">
      <g>
        <path
          d="M480.013,31.996c-133.453-70.359-271.75-15.094-360.016,73.172C39.606,185.574,10.044,341.339,56.278,419.37
    ...
    // <svg viewBox="0 0 15 15" fill="white">
    //   <path
    //     stroke="white"
